...
def parse_eval_configs():
    ...
    parser.add_argument('--pretrained_path', type=str, default=r"E:\python_files\Complex-YOLOv4-Pytorch-master\checkpoints\complex_YOLOv4\complex_yolov4_mse_loss.pth", metavar='PATH',
